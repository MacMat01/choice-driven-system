...
namespace _Old.Tests.EditMode.SchemaImporter
{
    public class DynamicDataImporterCsvIntegrationTests
    {
        ...
        public void RegisterParser_AllowsCustomExtensionImport()
        {
            ...
            string tempFilePath = Path.Combine(Path.GetTempPath(), $"weighted-draw-{Guid.NewGuid():N}.foo");
        ...
        private sealed class StubFooParser : ISchemaDataParser
        {
            ...
            {
                return string.Equals(normalizedExtension, ".foo", StringComparison.OrdinalIgnoreCase);
            }
